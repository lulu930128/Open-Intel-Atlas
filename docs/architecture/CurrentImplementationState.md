...
1.4.0 已納入七組 Macro、schema 11、39 指標，以及 Entity/Company、source-result 與頁面依賴。隔離候選版本通過 162 項測試；新版採用證據見[發布紀錄](../agent-runs/macro-closeout/Release-1.4.0.md)。以下為先前公開文件的歷史基準，不代表 1.4.0 的功能上限。
